...
RSpec.describe Facility do
  ...
  describe '#registers vehicles' do
    it 'adds vehicle registration and fees' do 
  ...
  describe "#administer_tests" do
    it 'a facility can administer a written test to a registrant' do
    ...
    it 'a facility can admister a road test to a registrant if they have passed their written test' do
      registrant_1 = Registrant.new('Bruce', 18, true)
      registrant_2 = Registrant.new('Penny', 16 )
      registrant_3 = Registrant.new('Tucker', 15 )
      ...
      registrant_2.administer_road_test
  ...
  describe '#gets_license' do
    it 'a facility approves a new license' do
      registrant_1 = Registrant.new('Bruce', 18, true)
      registrant_2 = Registrant.new('Penny', 16 )
      registrant_3 = Registrant.new('Tucker', 15 )
      ...
      registrant_2.renew_drivers_license
